...
![Request Flow](images/OIDC-Flow.png)
...
Now, create a second client, named "opencharity".
...
In my case it's user / pass was demouser / demouser, remember? We also created a client named "opencharity" and we gave
